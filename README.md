...
AI Study Planner — это учебный планировщик для студентов, который помогает организовать занятия, отслеживать прогресс и получать умные подсказки. Проект построен на Flask и хранит данные в SQLite локально и PostgreSQL на Render.
